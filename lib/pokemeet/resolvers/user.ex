defmodule Pokemeet.Resolvers.UserResolver do
  alias Pokemeet.{Guardian, User}
  alias Pokemeet.Service.UserService

  def search_users(_parent, args, %{context: %{current_user: current_user}}) do
    {:ok, UserService.search(args[:search_term], current_user)}
  end
